const CACHE = 'ml-recall-v12-20260818';
const CORE = [
  './', './index.html', './styles.css?v=12', './app.js?v=12', './question-bank.js?v=12',
  './manifest.webmanifest?v=12', './math-mode.js?v=12', './icons/icon-192.png', './icons/icon-512.png'
];
